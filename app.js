  ...
  var S4 = (function () {
    ...
    function openDeepDive(agentId) {
      ...
      el("dd-btn-urn").setAttribute("data-urn",
        "urn:agent:example-gcp-project:us-central1:" + a.id.toLowerCase());
      ...
      if (recCard) {
        if (asset) {
          ...
          if (asset.video) {
            ...
            // External build: the recording lives in the access-controlled
            // showcase; the sales script still tells the story.
